    ...
    <div class="cow-screen-form userInfo-box" :class='isBoxActive?"active":""'>
      <div class="form-wrapper">
        <div class="userInfo-container type-container">
          <p class="title"><i class="iconfont icon-zliconwarning01"></i>牛哥请你完善资料了</p>
          ...
          <div class="cow-input-content">
            ...
            <div class="input-box">
              <input type="text" v-model='inputList.introduce.val' placeholder="一句话描述自己的爱好" :class="inputList.introduce.verified?'':'error'">
            </div>
          </div>
